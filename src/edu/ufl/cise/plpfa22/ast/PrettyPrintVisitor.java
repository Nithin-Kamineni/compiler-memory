...
public class PrettyPrintVisitor implements ASTVisitor {
    ...
    public Object visitExpressionIdent(ExpressionIdent expressionIdent, Object
        ...
        String name =
                String.valueOf(expressionIdent.getFirstToken().getText());
    ...
    public Object visitExpressionStringLit(ExpressionStringLit
        ...
        sb.append("StringLit \"" +
                expressionStringLit.getFirstToken().getStringValue() + "\"");
        return null;
    }
    @Override
    public Object visitExpressionBooleanLit(ExpressionBooleanLit
                                                    expressionBooleanLit, Object arg) throws PLPException {
        sb.append("BooleanLit " +
                expressionBooleanLit.getFirstToken().getBooleanValue());
        return null;
    }
    @Override
    ...
    public Object visitConstDec(ConstDec constDec, Object arg) throws
        ...
        sb.append("CONST " + identText + "=" + valueText + " at nest level " +
                nest+ " type=" + type);
        return null;
    }
    @Override
