...
public class CodeGenTests {
    /**
     * Generates  a classfile for the given source program.  The classfile has
     the given name and package.
     *
     * @param input
     * @param className
     * @param packageName
     ...
     * @throws Exception
     */
    byte[] compile(String input, String className, String packageName) throws
            Exception {
        show("*****************");
        show(input);
        ...
        byte[] bytecode = (byte[])
                ast.visit(CompilerComponentFactory.getCodeGenVisitor(className, packageName, ""),
                        null);
    ...
    /**
     * Executes indicated method defined in bytecode and returns the result. args
     is
    ...
    Object runMethod(Class<?> testClass, String methodName, Object[] args) throws
            Exception {
